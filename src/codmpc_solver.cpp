...
void codmpcSolver::computeQPmatrices(std::string const &subsystems_name,
    ...
    // J_matrix.block(0, 0, 3, 3) = contact_cmd[s_idx]*quadruped_model_.J_linear_leg_[s_idx];
    // J_matrix.block(3, 3, 3, 3) = contact_cmd[s_idx+1]*quadruped_model_.J_linear_leg_[s_idx+1];
