...
def visualize_robot_data(csv_file_path1, csv_file_path2):
    """
...
##########   
        # 读取CSV文件
        print(f"正在读取数据文件: {csv_file_path1}")
        ...
        fig1.suptitle(csv_file_path1 +' state', fontsize=20, y=0.99)
        ...
        fig2.suptitle(csv_file_path1 +' control input', fontsize=20, y=0.99)
...
##########   
        # 读取CSV文件
        print(f"正在读取数据文件: {csv_file_path2}")
        ...
        # fig1, axs1 = plt.subplots(9, 4, figsize=(20, 24))  # 9行4列共36个子图
        fig1, axs1 = plt.subplots(6, 6, figsize=(20, 24))  # 6行6列共36个子图
        fig1.suptitle(csv_file_path2 +' state', fontsize=20, y=0.99)
        axs1 = axs1.flatten()  # 将子图数组展平以便迭代
        ...
        print("Create control input graph...")
        fig2, axs2 = plt.subplots(3, 6, figsize=(20, 24))
        fig2.suptitle(csv_file_path2 +' control input', fontsize=20, y=0.99)
        axs2 = axs2.flatten()  # 将子图数组展平以便迭代
...
if __name__ == "__main__":
    # 读取并可视化机器人数据
    visualize_robot_data('front_data.csv', 'back_data.csv')
